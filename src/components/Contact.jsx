            ...
            <div class="grid grid-cols-1 md:grid-cols-2">
                ...
                <form class="p-6 flex flex-col justify-center max-w-[700px]" action="https://getform.io/f/lakoldja" method="post">
                    <div class="flex flex-col">
                        <input required type="name" name="name" id="name" placeholder="Full Name" class="w-100 mt-2 p-3 rounded-lg bg-gray-800 border border-gray-700 text-white" />
                    </div>

                    <div class="flex flex-col mt-2">
                        <input required type="email" name="email" id="email" placeholder="Email" class="w-100 mt-2 py-3 px-3 rounded-lg bg-gray-800 border border-gray-700 text-white" />
                    </div>
                    
                    <div class="flex flex-col mt-2">
                        <textarea required type="message" name="name" id="name" placeholder="Message" class="w-100 max-h-[200px] mt-2 py-3 px-3 rounded-lg bg-gray-800 border border-gray-700 text-white"></textarea>
                    </div>
